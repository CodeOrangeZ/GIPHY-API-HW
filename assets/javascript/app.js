...
// and allow text to be pushed into to create new search requests
...
// to store it all in
          ...
          giphD.append(giphI);
// appending the <div> holding the gif and rating to a class(thats attached to an HTML element)
          $('.giphGoesHere').append(giphD);
          }
      });
};
...
$(document).on("click", ".gImage", function() {
